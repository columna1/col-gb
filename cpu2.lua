...
function()  local temp = self.A - self.B ; self.F = temp<0 and 0x50 or 0x40; cycles = cycles + 4 end,--[184 0xb8]
function()  local temp = self.A - self.C ; self.F = temp<0 and 0x50 or 0x40; cycles = cycles + 4 end,--[185 0xb9]
function()  local temp = self.A - self.D ; self.F = temp<0 and 0x50 or 0x40; cycles = cycles + 4 end,--[186 0xba]
function()  local temp = self.A - self.E ; self.F = temp<0 and 0x50 or 0x40; cycles = cycles + 4 end,--[187 0xbb]
function()  local temp = self.A - self.H ; self.F = temp<0 and 0x50 or 0x40; cycles = cycles + 4 end,--[188 0xbc]
function()  local temp = self.A - self.L ; self.F = temp<0 and 0x50 or 0x40; cycles = cycles + 4 end,--[189 0xbd]
function()  local t = mem.getByte((lshift(self.H,8)+self.L)) ;  local temp = self.A - t ; self.F = temp<0 and 0x50 or 0x40; cycles = cycles + 8 end,--[190 0xbe]
function()  local temp = self.A - self.A ; self.F = temp<0 and 0x50 or 0x40; cycles = cycles + 4 end,--[191 0xbf]
...
function()  local t = mem.getByte(self.PC) ;  local temp = self.A - t ; self.F = temp<0 and 0x50 or 0x40; cycles = cycles + 8; self.PC = self.PC+ 1 end,--[254 0xfe]
